...
python analysis.py --ref $BASE_DIR/references/${NAME}.pdb --trjdir $MD_DIR --ref_rmsd $REF_RMSD --figpath $BASE_DIR/analysis/${NAME}_ref_rmsd.png
...
if [ -d $MD_DIR ]; then
    ...
    if [ $counter -eq 0 ]; then
        ...
        python analysis.py --ref $BASE_DIR/references/${NAME}.pdb --trjdir $MD_DIR --ref_rmsd $REF_RMSD --figpath $BASE_DIR/analysis/${NAME}_ref_rmsd_amber.png
    fi
fi